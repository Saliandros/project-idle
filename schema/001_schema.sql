...
-- This file is for reference and should be kept in sync with production.
...
create table public.profile_champions (
  ...
  constraint profile_champions_profile_id_champion_id_key unique (profile_id, champion_id),
...
create table public.profile_factions (
  ...
  constraint profile_factions_profile_id_faction_id_key unique (profile_id, faction_id),
...
create table public.resources (
  ...
  constraint resources_profile_id_type_key unique (profile_id, type),
