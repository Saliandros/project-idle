      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.tabRow}>
          <TouchableOpacity
            style={[
              styles.tabButton,
              activeTab === "champions" && styles.tabButtonActive,
            ]}
          ...
          <TouchableOpacity
            style={[
              styles.tabButton,
              activeTab === "unlocks" && styles.tabButtonActive,
            ]}
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.unlockRow,
                      isUnlocked
                        ? styles.unlockRowUnlocked
                        : styles.unlockRowLocked,
                    ]}
                    activeOpacity={0.8}
                    onPress={
                      isUnlocked
                        ? undefined
                        : () => handleUnlockPress(faction.id)
                    }
                  >
                    <View>
                      <Text
          ...
          <View style={styles.modalOverlay}>
            <View style={styles.modalContainer}>
              ...
              <Text style={styles.modalMessage}>
                {lockedFactionName} are still Locked
              </Text>
