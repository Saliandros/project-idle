            ...
            <View style={styles.headerSection}>
              ...
              >
                <View style={styles.factionTriggerTextWrap}>
                  <Text style={styles.factionTriggerEyebrow}>
                    Active Faction
                  </Text>
            ...
            <View style={styles.sidePanel}>
              <View style={styles.sidePanelHeader}>
                ...
                <View style={styles.sidePanelGoldWrap}>
                  ...
                  />
                  <Text style={styles.sidePanelGoldText}>
                    {formatDisplayNumber(goldAmount)}
                  </Text>
                </View>
              </View>
                ...
                <TouchableOpacity
                  style={[
                    ...
                    desktopFactionTab === "champions" &&
                      styles.sidePanelTabButtonActive,
                  ]}
                  activeOpacity={0.85}
                ...
                {desktopFactionTab === "champions"
                  ? factionDefinitions.map((entry) => (
                      <TouchableOpacity
                        ...
                        style={[
                          styles.sidePanelRow,
                          unlockedFactionIds.includes(entry.id)
                            ? styles.sidePanelRowActive
                            : styles.sidePanelRowLocked,
                          activeFactionId === entry.id &&
                            styles.sidePanelRowCurrent,
                        ]}
                        activeOpacity={0.85}
                        onPress={() => handleFactionPress(entry)}
                      >
                        <View style={styles.sidePanelRowContent}>
                          <Text style={styles.sidePanelRowTitle}>
                            {entry.label}
                          </Text>
                  ...
                  : desktopUnlockRows
                      ...
                      .map((entry) => {
                        const isUnlocked = unlockedFactionIds.includes(
                          entry.id,
                        );
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.pickerRow,
                      isUnlocked
                        ? styles.pickerRowUnlocked
                        : styles.pickerRowLocked,
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <Text style={styles.modalMessage}>
              {lockedFactionName} Faction is still Locked
            </Text>
            <Text style={styles.modalSubtext}>
              Raise your standing with {lockedFactionName} to be able to
              purchase "unlock"
            </Text>
            <TouchableOpacity
              style={styles.modalButton}
